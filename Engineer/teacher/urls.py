...
urlpatterns = [
    ...
    path('dashboard/new_task_data/', Create_task.as_view(), name='creation_tasks'),
    path('dashboard/new_group/', include('main.urls')),
    path('dashboard/new_group_data/', Add_group.as_view(), name='creation_groups'),
    path('dashboard/add_student', include('main.urls')),
    path('dashboard/add_student_data/', Add_Student.as_view(), name='add_student'),
    path('dashboard/add_test/', include('main.urls')),
    path('dashboard/add_test_data/', Add_Test.as_view(), name='add_test'),
